...
if __name__=='__main__':
    json_input_directory = os.path.join(REDMINE_ISSUES_DIRECTORY, '2021-0820')

    kwargs = dict(include_comments=True\
                , redmine_issue_start_number=4666\
                , redmine_issue_end_number=9140\
                ...
                , label_mapping_filename=None # LABEL_MAP_FILE     # optional
